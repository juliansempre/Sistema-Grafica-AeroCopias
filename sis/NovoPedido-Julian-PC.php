...
?>
    <center>
    <div><a href="index.html"><input type="button" class="inicioa" value="Inicio"></a> <a href="imp/imp.htm" target="_blank"><input type="button" class="impri" value=" Visualizar ultimo pedido "></a></div>
