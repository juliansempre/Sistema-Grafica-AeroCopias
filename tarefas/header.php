<?php require_once("config/conexao.php");
    ...
    // $dda = date("Y/m/d"); //, strtotime("-0 days")
    // exibe pedidos de 2 semanas atras
    $sql = "SELECT * FROM tarefas WHERE data_tarefa BETWEEN CURRENT_DATE()-14 AND CURRENT_DATE() ORDER BY data_tarefa DESC;";
