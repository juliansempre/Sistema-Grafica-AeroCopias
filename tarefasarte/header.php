<?php require_once("config/conexao.php");
    ...
    $sql = "SELECT * FROM tarefasarte WHERE data_tarefa BETWEEN CURRENT_DATE()-14 AND CURRENT_DATE() ORDER BY data_tarefa DESC;";
