        ...
        <table class="striped">
            ...
            <?php foreach ($result_tarefas as $tarefa) { ?>
                ...
                <td>
                    ...
                    <a href="config/enviado_tarefa.php?id=<?= $tarefa['id']?>" title="Enviado"><button> Enviado </button></a>
                     <a href="config/alteracao_tarefa.php?id=<?= $tarefa['id']?>" title="Alterarcao"><button> Alteração </button></a>
                     <a href="config/aprovado_tarefa.php?id=<?= $tarefa['id']?>" title="Aprovado"><button> Aprovado </button></a>
                </td>
            </tr>
            <?php } ?>
        </table>
